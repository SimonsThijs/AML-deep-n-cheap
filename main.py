...
if __name__ == '__main__':
    ...
    parser.add_argument("--network", type = str, default='cnn', help = "Choose from 'cnn' or 'mlp' or 'mlp_st'")
    ...
    parser.add_argument("--data_folder2", type = str, default='./', help = "Path to folder where dataset is stored")
    parser.add_argument("--dataset2", type = str, default='mnist', help = "Either something like 'mnist', or something like 'mnist.npz'")
    parser.add_argument("--input_size2", type = int, nargs='+', default=[3,32,32], help = "Dimensions of 1 input data sample")
    parser.add_argument("--output_size2", type = int, default=10, help = "Sumber of classes")

    parser.add_argument("--data_folder3", type = str, default='./', help = "Path to folder where dataset is stored")
    parser.add_argument("--dataset3", type = str, default='mnist', help = "Either something like 'mnist', or something like 'mnist.npz'")
    parser.add_argument("--input_size3", type = int, nargs='+', default=[3,32,32], help = "Dimensions of 1 input data sample")
    parser.add_argument("--output_size3", type = int, default=10, help = "Sumber of classes")
    ...
    parser.add_argument("--problem_type2", type = str, default = 'classification', help = "Choose from 'classification' or 'regression'")
    parser.add_argument("--problem_type3", type = str, default = 'classification', help = "Choose from 'classification' or 'regression'")
    ...
    from model_search import run_model_search_cnn, run_model_search_mlp, mlp_search_transfer
    ...
    if args.dataset2[-4:] == '.npz':
        # use .npz files
        dataset2 = args.dataset2[:-4]
        data2 = get_data_npz(data_folder=args.data_folder, dataset=args.dataset2, val_split=args.val_split, problem_type=args.problem_type2)
    else:
        # use framework built-in datasets
        dataset2 = args.dataset2
        data2 = get_data(data_folder=args.data_folder2, dataset=args.dataset2, val_split=args.val_split, augment=args.augment)
    dataset_code2 = 'M' if dataset2=='mnist' else 'F' if dataset2=='fmnist' else 'R' if dataset2=='rcv1_2000' else 'XXX'

    if args.dataset3[-4:] == '.npz':
        # use .npz files
        dataset3 = args.dataset3[:-4]
        data3 = get_data_npz(data_folder=args.data_folder, dataset=args.dataset3, val_split=args.val_split, problem_type=args.problem_type3)
    else:
        # use framework built-in datasets
        dataset3 = args.dataset3
        data3 = get_data(data_folder=args.data_folder3, dataset=args.dataset3, val_split=args.val_split, augment=args.augment)
    
    dataset_code3 = 'M' if dataset3=='mnist' else 'F' if dataset3=='fmnist' else 'R' if dataset3=='rcv1_2000' else 'XXX'
    ...
    elif args.network == 'mlp_st':
        mlp_search_transfer(data=data, dataset_code=dataset_code,
                            input_size=args.input_size, output_size=args.output_size, problem_type=args.problem_type, verbose=args.verbose,
                            wc=args.wc, penalize=args.penalize, tbar_epoch=args.tbar_epoch, numepochs=args.numepochs, val_patience=args.val_patience,
                            bo_prior_states=args.bo_prior_states, bo_steps=args.bo_steps, bo_explore=args.bo_explore,
                            num_hidden_layers=args.num_hidden_layers, hidden_nodes=args.hidden_nodes, lr=args.lr, weight_decay=args.weight_decay, batch_size=args.batch_size,
                            ...
                            data2=data2, dataset_code2=dataset_code2,
                            input_size2=args.input_size2, output_size2=args.output_size2, problem_type2=args.problem_type2,

                            data3=data3, dataset_code3=dataset_code3,
                            input_size3=args.input_size3, output_size3=args.output_size3, problem_type3=args.problem_type3,
                            )
